module.exports = {
    ...
    messages: {
        initial_case: function (firstName) {
            return `Հարգելի ${firstName} 👋, Եթե կցանկանաք ստանալ 18+ անեկդոտներ ապա սեխմեք /over18 ի վրա )), համակարգի սառեցման համար /stop -ի վրա սեխմեք 
        ...
        success_stop_request: function (firstName) {
            return `Հարգելի ${firstName}, Ես դադարեցնում եմ Ձեզ ուրախացնել։ Եթե կցանկանաք վերականգնել աշխտանքն ապա սեղմեն /start հրամանն`
        },
